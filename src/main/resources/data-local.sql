...
-- Completed recipe
INSERT INTO recipe (owner_id, name, completed, category_id, img_url, created_at, updated_at) VALUES (1, '로즈마리 후추 버거', true, 1, '/img/recipe-default.png', now(), now());
...
-- Incompleted recipe
INSERT INTO recipe (owner_id, name, completed, category_id, img_url, created_at, updated_at) VALUES (1, '김치 피자', false, 1, '/img/recipe-default.png', now(), now());
